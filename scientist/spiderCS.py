...
def main():
    ...
    baseurl = 'https://zh.wikipedia.org/wiki/Category:%E4%B8%AD%E5%9B%BD%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%A7%91%E5%AD%A6%E5%AE%B6'
    print('write...')
    datalist = getData(baseurl)
    print('done')
    savepath = "中国计算机科学家.xls"
    # 3.保存数据
    saveData(datalist, savepath)
    print('中国计算机科学家信息已爬取完毕！')
...
def saveData(datalist,savepath):
    ...
    worksheet = workbook.add_sheet('中国计算机科学家',cell_overwrite_ok=True)  # 创建工作表
